...
public class ForwardList : List<Forward>, ICommittable
{
    ...
    public new Forward this[int index] { get => base[index];
        set { _changed = true; base[index] = value; } }
    public new void Add(Forward item) { _changed = true; base.Add(item); }
    public new void AddRange(IEnumerable<Forward> collection) { _changed = true; base.AddRange(collection); }
    ...
    public new void Insert(int index, Forward item) { _changed = true; base.Insert(index, item); }
    public new void InsertRange(int index, IEnumerable<Forward> collection) { _changed = true; base.InsertRange(index, collection); }
    ...
    public new bool Remove(Forward item) { _changed = true; return base.Remove(item); }
    public new int RemoveAll(Predicate<Forward> match) { _changed = true; return base.RemoveAll(match); }
    ...
    public new void Sort(IComparer<Forward> comparer) { _changed = true; base.Sort(comparer); }
    public new void Sort(Comparison<Forward> comparison) { _changed = true; base.Sort(comparison); }
    public new void Sort(int index, int count, IComparer<Forward> comparer) { _changed = true; base.Sort(index, count, comparer); }
