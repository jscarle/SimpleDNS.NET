...
namespace SimpleDNS.Options
{
    public class TransferKeyList : List<TransferKey>, ICommittable
    {
        ...
        public bool Changed
        {
            get
            {
                foreach (TransferKey item in this)
        ...
        public new TransferKey this[int index] { get { return base[index]; } set { changed = true; base[index] = value; } }
        public new void Add(TransferKey item) { changed = true; base.Add(item); }
        public new void AddRange(IEnumerable<TransferKey> collection) { changed = true; base.AddRange(collection); }
        ...
        public new void Insert(int index, TransferKey item) { changed = true; base.Insert(index, item); }
        public new void InsertRange(int index, IEnumerable<TransferKey> collection) { changed = true; base.InsertRange(index, collection); }
        ...
        public new bool Remove(TransferKey item) { changed = true; return base.Remove(item); }
        public new int RemoveAll(Predicate<TransferKey> match) { changed = true; return base.RemoveAll(match); }
        ...
        public new void Sort(IComparer<TransferKey> comparer) { changed = true; base.Sort(comparer); }
        public new void Sort(Comparison<TransferKey> comparison) { changed = true; base.Sort(comparison); }
        public new void Sort(int index, int count, IComparer<TransferKey> comparer) { changed = true; base.Sort(index, count, comparer); }
