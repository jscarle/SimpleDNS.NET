...
public class UpdateKeyList : List<UpdateKey>, ICommittable
{
    ...
    public new UpdateKey this[int index] { get => base[index];
        set { _changed = true; base[index] = value; } }
    public new void Add(UpdateKey item) { _changed = true; base.Add(item); }
    public new void AddRange(IEnumerable<UpdateKey> collection) { _changed = true; base.AddRange(collection); }
    ...
    public new void Insert(int index, UpdateKey item) { _changed = true; base.Insert(index, item); }
    public new void InsertRange(int index, IEnumerable<UpdateKey> collection) { _changed = true; base.InsertRange(index, collection); }
    ...
    public new bool Remove(UpdateKey item) { _changed = true; return base.Remove(item); }
    public new int RemoveAll(Predicate<UpdateKey> match) { _changed = true; return base.RemoveAll(match); }
    ...
    public new void Sort(IComparer<UpdateKey> comparer) { _changed = true; base.Sort(comparer); }
    public new void Sort(Comparison<UpdateKey> comparison) { _changed = true; base.Sort(comparison); }
    public new void Sort(int index, int count, IComparer<UpdateKey> comparer) { _changed = true; base.Sort(index, count, comparer); }
