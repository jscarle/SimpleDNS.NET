...
namespace SimpleDNS.Options
{
    public class MasterList : List<Master>, ICommittable
    {
        ...
        public new Master this[int index] { get { return base[index]; } set { changed = true; base[index] = value; } }
        public new void Add(Master item) { changed = true; base.Add(item); }
        public new void AddRange(IEnumerable<Master> collection) { changed = true; base.AddRange(collection); }
        ...
        public new void Insert(int index, Master item) { changed = true; base.Insert(index, item); }
        public new void InsertRange(int index, IEnumerable<Master> collection) { changed = true; base.InsertRange(index, collection); }
        ...
        public new bool Remove(Master item) { changed = true; return base.Remove(item); }
        public new int RemoveAll(Predicate<Master> match) { changed = true; return base.RemoveAll(match); }
        ...
        public new void Sort(IComparer<Master> comparer) { changed = true; base.Sort(comparer); }
        public new void Sort(Comparison<Master> comparison) { changed = true; base.Sort(comparison); }
        public new void Sort(int index, int count, IComparer<Master> comparer) { changed = true; base.Sort(index, count, comparer); }
